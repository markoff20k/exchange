...
export const pt = {
	...
	'page.body.trade.header.newOrder.content.orderType.limit': 'Ordem Limite',
	...
	'page.body.trade.toolBar.change': 'Alteracão',
	...
	'page.body.trade.header.recentTrades': 'Histórico de negociação',
